                                ...
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                <form class="form"
                                                    action="{{ route('nominal.update', $nominals->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="row">
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="first-name-column"
                                                                    ...
                                                                    name="coinName"
                                                                    value="{{ old('coinName') ?? $nominals->coinName }}"
                                                                    required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" id="last-name-column"
                                                                    ...
                                                                    name="amountCoin"
                                                                    value="{{ old('amountCoin') ?? $nominals->amountCoin }}"
                                                                    required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" id="city-column"
                                                                    ...
                                                                    name="coinPrice"
                                                                    value="{{ old('coinPrice') ?? $nominals->coinPrice }}"
                                                                    required>
                                                            </div>
                                                        </div>
