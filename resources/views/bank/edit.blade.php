                                ...
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                <form class="form" action="{{ route('bank.update', $banks->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('PUT')
                                                    <div class="row">
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="first-name-column"
                                                                    ...
                                                                    name="ownerName"
                                                                    value="{{ old('ownerName') ?? $banks->ownerName }}"
                                                                    required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="first-name-column"
                                                                    ...
                                                                    name="bankName"
                                                                    value="{{ old('bankName') ?? $banks->bankName }}"
                                                                    required>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" id="city-column"
                                                                    ...
                                                                    name="accountNumber"
                                                                    value="{{ old('accountNumber') ?? $banks->accountNumber }}"
                                                                    required>
                                                            </div>
                                                        </div>
