    ...
    return {
        execute: function () {
            ...
            class r {
                ...
                filter(t, e, s, a) {
                    ...
                    const n = i.filterState[t](),
                        h = Array.from(i.filterState.originalData).filter(
                            (e) => {
                                const s = e.cells[t],
                ...
                sort(t, s, a) {
                    ...
                    if (n && 0 !== n.length)
                        return void this.filter(t, s, a, n);
                    (i.sorting = !0), a || i.emit("datatable.sorting", t, s);
                    let l = i.data;
                    const r = [],
                        o = [];
                    let d = 0,
                        c = 0;
                    const p = i.headings[t],
                        g = [];
                    if ("date" === p.getAttribute("data-type")) {
                        ...
                        p.hasAttribute("data-format") &&
                            ...
                            g.push(
                                e.import("./date-88c20685.js").then(
                                    ({ parseDate: e }) =>
                                        (s) =>
                                            e(s, t)
                                )
            ...
            class c {
                ...
                static extend(t, e) {
                    "function" == typeof e ? (c.prototype[t] = e) : (c[t] = e);
                }
                init(t) {
                    if (
                        this.initialized ||
                ...
                renderPager() {
                    if ((i(this.pagers), this.totalPages > 1)) {
                        ...
                        this.options.truncatePager &&
                            ...
                            this.options.nextPrev &&
                                e.appendChild(n(t, i, this.options.nextText)),
                            this.options.firstLast &&
                                e.appendChild(
                                    n(t, this.totalPages, this.options.lastText)
                                ),
                            ...
                            this.options.columns.forEach((t) => {
                                Array.isArray(t.select) ||
                                    ...
                                    t.select.forEach((e) => {
                                        ...
                                        t.type &&
                                            s.setAttribute("data-type", t.type),
                                            t.format &&
                                                s.setAttribute(
                                                    "data-format",
                                                    t.format
                ...
                import(t) {
                    ...
                    if (a.data.length || s(a.data)) {
                        ...
                        s(a.data) && (e = a.data), e && this.insert(e);
                    }
                    return !1;
                }
                print() {
                    const t = this.activeHeadings,
                        ...
                        h = a("tr");
                    t.forEach((t) => {
                        h.appendChild(a("th", { html: t.textContent }));
                    }),
                        i.appendChild(h),
                        e.forEach((t) => {
                            const e = a("tr");
